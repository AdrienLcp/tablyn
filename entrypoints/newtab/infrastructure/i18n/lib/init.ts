...
type Register = { translations: typeof en }
...
export function initI18n({
  ...
  function translate<S extends PathsWithParams, A extends Params<S>>(
    key: S,
    args: A
  ): string
  function translate<S extends DotPathsFor, A extends Params<S>>(
    key: S,
    args?: A
  ) {
